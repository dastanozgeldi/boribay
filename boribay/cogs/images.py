...
from boribay.utils import (Cog, Manip, make_image, make_image_url,
                           polaroid_filter)
...
class Images(Cog):
    ...
    @commands.command()
    async def monochrome(self, ctx: Context, r: Optional[int], g: Optional[int], b: Optional[int], image: Optional[str]):
